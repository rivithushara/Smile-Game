...
public class GamePlayModeController{
	...
	@FXML //For the ### button
	private Button EasyP,NormalP,Hard;
	@FXML
	...
	public void easyModePlayOnAction(ActionEvent event) { // to go to the Game
		...
		mediaPlayer.play();
		Stage stage = (Stage) EasyP.getScene().getWindow();
		stage.close();
		easy();
	}
	...
	public void easy() {
		try {
			FXMLLoader fxmlLoader = new FXMLLoader(GameApplication.class.getResource("easyMode.fxml"));
	...
	public void normalModePlayOnAction(ActionEvent event) { // to go to the Login GUI
		...
		mediaView.setMediaPlayer(mediaPlayer);
		mediaPlayer.play();
		Stage stage = (Stage) NormalP.getScene().getWindow();
		stage.close();
		normal();
	}
	...
	public void normal() {
		try {
			FXMLLoader fxmlLoader = new FXMLLoader(GameApplication.class.getResource("normalMode.fxml"));
			Scene scene = new Scene(fxmlLoader.load(), 920, 580);
